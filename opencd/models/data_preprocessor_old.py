...
class DualInputSegDataPreProcessor(BaseDataPreprocessor):
    ...
    def forward(self, data: dict, training: bool = False) -> Dict[str, Any]:
        ...
        #     print(np.unique(data['data_samples'][i].gt_sem_seg.data.cpu()))
        #     # print(data['data_samples'][i].gt_sem_seg.data[data['data_samples'][i].gt_sem_seg.data==1].size(0))
        #     if data['data_samples'][i].gt_sem_seg.data[data['data_samples'][i].gt_sem_seg.data==255].size(0) > 0:
        #         print(data['data_samples'][i].label_cd)
        #         print("有问题")
